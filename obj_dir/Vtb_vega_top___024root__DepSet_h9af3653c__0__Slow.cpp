...
VL_ATTR_COLD void Vtb_vega_top___024root___eval_initial__TOP(Vtb_vega_top___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_vega_top___024root___eval_initial__TOP\n"); );
    // Init
    VlWide<3>/*95:0*/ __Vtemp_1;
    // Body
    vlSelf->tb_vega_top__DOT__clk = 0U;
    __Vtemp_1[0U] = 0x2e766364U;
    __Vtemp_1[1U] = 0x5f746f70U;
    __Vtemp_1[2U] = 0x76656761U;
...
VL_ATTR_COLD void Vtb_vega_top___024root___eval_triggers__stl(Vtb_vega_top___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtb_vega_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_vega_top___024root___eval_triggers__stl\n"); );
    // Body
